...
import 'package:hussein_wallpaper/pages/welcomepage.dart';
import 'package:hussein_wallpaper/sendtrafic/sendtraficpage.dart';
...
Future<void> _getAppNumber() async {
  if (await _checkInteretStatu()) {
    final response = await http.get(Uri.parse(
        'https://raw.githubusercontent.com/izosinan/jsons/main/imam_hussain_data2.json'));
